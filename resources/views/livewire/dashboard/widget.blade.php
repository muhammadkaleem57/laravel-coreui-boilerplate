                ...
                <div class="card-body card-body pb-0 d-flex justify-content-between align-items-start">
                    ...
                    <div class="btn-group">
                        <button class="btn btn-transparent dropdown-toggle p-0" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <i class="c-icon icon-settings"></i>
                        </button>
                ...
                <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                    <div class="btn-group btn-group-toggle mx-3" data-toggle="buttons">
                        <label class="btn btn-outline-secondary">
                            <input id="option1" type="radio" name="options" autocomplete="off"> Day </label>
                        <label class="btn btn-outline-secondary active">
                            <input id="option2" type="radio" name="options" autocomplete="off" checked=""> Month </label>
                        <label class="btn btn-outline-secondary">
                            <input id="option3" type="radio" name="options" autocomplete="off"> Year </label>
                    </div>
                    <button class="btn btn-primary" type="button">
                        <i class="c-icon icon-cloud-download"></i>
                    </button>
                </div>
            </div>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                <div class="card-header bg-facebook content-center">
                    <i class="c-icon c-icon-3xl text-white my-4 icon-social-facebook"></i>
                </div>
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                <div class="card-header bg-twitter content-center">
                    <i class="c-icon c-icon-3xl text-white my-4 icon-social-twitter"></i>
                </div>
                <div class="card-body row text-center">
                    <div class="col">
        ...
        <div class="col-sm-6 col-lg-4">
            <div class="card">
                <div class="card-header bg-linkedin content-center">
                    <i class="c-icon c-icon-3xl text-white my-4 icon-social-linkedin"></i>
                </div>
                <div class="card-body row text-center">
                    <div class="col">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="progress-group">
                                <div class="progress-group-header">
                                    <i class="c-icon progress-group-icon icon-user"></i>
                                    <div>Male</div>
                            ...
                            <div class="progress-group mb-5">
                                <div class="progress-group-header">
                                    <i class="c-icon progress-group-icon icon-user-female"></i>
                                    <div>Female</div>
                            ...
                            <div class="progress-group">
                                <div class="progress-group-header align-items-end">
                                    <i class="c-icon progress-group-icon icon-social-google"></i>
                            ...
                            <div class="progress-group">
                                <div class="progress-group-header align-items-end">
                                    <i class="c-icon progress-group-icon icon-social-facebook"></i>
                                    <div>Facebook</div>
                            ...
                            <div class="progress-group">
                                <div class="progress-group-header align-items-end">
                                    <i class="c-icon progress-group-icon icon-social-twitter"></i>
                                    <div>Twitter</div>
                            ...
                            <div class="progress-group">
                                <div class="progress-group-header align-items-end">
                                    <i class="c-icon progress-group-icon icon-social-linkedin"></i>
                                    <div>LinkedIn</div>
                    ...
                    <table class="table table-responsive-sm table-hover table-outline mb-0">
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="c-avatar">
                                    <img class="c-avatar-img" src="{{asset('assets/img/avatars/1.jpg')}}" alt="">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/flag.svg#cif-us')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xli">
                                    <use xlink:href="{{asset('assets/sprites/brand.svg#cib-cc-mastercard')}}"></use>
                                </svg>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="c-avatar">
                                    <img class="c-avatar-img" src="{{asset('assets/img/avatars/2.jpg')}}" alt="">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/flag.svg#cif-br')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/brand.svg#cib-cc-visa')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="small text-muted">Last login</div>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="c-avatar">
                                    <img class="c-avatar-img" src="{{asset('assets/img/avatars/3.jpg')}}" alt="">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/flag.svg#cif-pk')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/brand.svg#cib-cc-stripe')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="small text-muted">Last login</div>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="c-avatar">
                                    <img class="c-avatar-img" src="{{asset('assets/img/avatars/4.jpg')}}" alt="">
                                    <span class="c-avatar-status bg-secondary"></span>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/flag.svg#cif-fr')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/brand.svg#cib-cc-paypal')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="small text-muted">Last login</div>
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="c-avatar">
                                    <img class="c-avatar-img" src="{{asset('assets/img/avatars/5.jpg')}}" alt="">
                                    <span class="c-avatar-status bg-success"></span>
                                </div>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/flag.svg#cif-es')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/brand.svg#cib-cc-apple-pay')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="small text-muted">Last login</div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/flag.svg#cif-pl')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="clearfix">
                            ...
                            <td class="text-center">
                                <svg class="c-icon c-icon-xl">
                                    <use xlink:href="{{asset('assets/sprites/brand.svg#cib-cc-amex')}}"></use>
                                </svg>
                            </td>
                            <td>
                                <div class="small text-muted">Last login</div>
